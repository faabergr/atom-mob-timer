...
export default {
    ...
    updateTimerMessage() {
        var secondsRemainder = this.remainingTimeInSeconds % 60;
        var minutes = (this.remainingTimeInSeconds - secondsRemainder) / 60;
        var timeFormatted = (minutes > 0 ? minutes + 'm ' : '') + secondsRemainder + 's';
        this.mobTimerView.setMessage('Rotate in ' + timeFormatted);
    },
